...
struct Tag {
  std::variant<TagEnd, TagByte, TagShort, TagInt, TagLong, TagFloat, TagDouble,
               TagByteArray, TagString, std::shared_ptr<TagList>,
               std::shared_ptr<TagCompound>, TagIntArray, TagLongArray>
      data;
...
public:
  ...
  NBT(const std::string &name, const TagCompound &tags)
      : name(name), root(tags) {}
